...
import 'package:yoldaa/Kullanici.dart';
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                        child: Text("KAYDET",style: TextStyle(fontSize: ekranGenisligi/25, color: Colors.white),),
                        ...
                        onPressed: (){
                          if(formkey.currentState!.validate()){
                            ...
                            Kullanici kullanici = Kullanici(ad: ad, soyad: soyad, kullanici_adi: kullanici_adi, eposta: eposta, sifre: sifre);
